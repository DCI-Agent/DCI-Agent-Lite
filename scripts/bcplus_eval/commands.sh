...
bash scripts/bcplus_eval/run_bcplus_eval_100_openai.sh level0 medium > logs/bcplus_eval_100_openai_level0_medium.log 2>&1
...
# bash scripts/bcplus_eval/run_bcplus_eval_100_openai.sh level1 off > logs/bcplus_eval_100_openai_level1_off.log 2>&1
bash scripts/bcplus_eval/run_bcplus_eval_100_openai.sh level1 xhigh > logs/bcplus_eval_100_openai_level1_xhigh.log 2>&1
...
bash scripts/bcplus_eval/run_bcplus_eval_100_openai.sh level3 xhigh > logs/bcplus_eval_100_openai_level3_xhigh.log 2>&1
