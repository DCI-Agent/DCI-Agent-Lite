...
uv run python "$REPO_ROOT/scripts/bcplus_eval/run_bcplus_eval_100.py" \
  --enable-ir \
  --dataset "/home/ubuntu/demo/haoxiang/ir-eval/data/beir/fiqa/beir_fiqa_sample50.jsonl" \
  --output-root "$REPO_ROOT/outputs/beir/fiqa" \
  --corpus-dir "/home/ubuntu/demo/haoxiang/ir-eval/beir_corpus/fiqa" \
