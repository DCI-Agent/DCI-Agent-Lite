...
uv run python "$REPO_ROOT/scripts/bcplus_eval/run_bcplus_eval_100.py" \
  --enable-ir \
  --dataset "/home/ubuntu/demo/haoxiang/ir-eval/data/beir/scidocs/beir_scidocs_sample50.jsonl" \
  --output-root "$REPO_ROOT/outputs/beir/scidocs" \
  --corpus-dir "/home/ubuntu/demo/haoxiang/ir-eval/beir_corpus/scidocs" \
